function [encodingError,freq] = Mic2HoaEncodingError(mic2HoaCfg,varargin)
...
ordPhys = Hoa2MicRequiredOrder(micFmt,max(freq)) ;
...
T = Hoa2MicTransferMatrix(hoaFmtPhys,micFmt,freq) ;
