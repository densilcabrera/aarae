function OUT = LoudnessZwickerISO532(IN,fs,diffusefield)


% diffusefield - do diffuse field correction, otherwise do free field.
...
% **************************************************
% 1/3-octave band filterbank, as specified in ISO532
% **************************************************

br = [1,2,1;1,0,-1;1,-2,1];
ar = [1,-2,1;1,-2,1;1,-2,1];

% filter 'a' coefficient offsets
...
filteredaudio = zeros(len,chans,28);
for n = 1:28
